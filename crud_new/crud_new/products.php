...
<div class="products-container">
    ...
    <div class="top-nav">
        ...
        <div class="nav-right">
            <a href="dashboard.php" class="nav-btn"><i class="fas fa-home"></i> Dashboard</a>
            <a href="#" class="nav-btn add-product-btn" onclick="document.getElementById('addProductModal').style.display='block'">
